      ...
      <form enctype="multipart/form-data" action="<?php echo U('admin/goods/goodsadd');?>" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <td><input type="text" name="shop_price" value="" size="20" /></td>
          </tr>
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
            ...
            <td><input type="text" name="goods_weight" value="0.000" size="20" /> <select name="weight_unit"><option value="1" selected>千克</option><option value="0.001">克</option></select></td>
          </tr>
          <tr>
