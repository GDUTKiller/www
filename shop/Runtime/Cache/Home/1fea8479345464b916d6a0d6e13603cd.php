...
<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
		<tbody><tr>
            ...
            <?php if(is_array($items)): foreach($items as $key=>$v): ?><tr>
			<td bgcolor="#ffffff">
				<a  target="_blank"><?php echo ($v['goods_name']); ?></a>
			</td>
			<td bgcolor="#ffffff">颜色:黑色 <br></td>
						<td align="right" bgcolor="#ffffff">￥<?php echo ($v['market_price']); ?></td>
						<td class="price" align="right" bgcolor="#ffffff">￥<?php echo ($v['shop_price']); ?></td>
			<td align="right" bgcolor="#ffffff"><?php echo ($v['num']); ?></td>
			<td class="price" align="right" bgcolor="#ffffff">￥<?php echo ($v['shop_price'] * $v['num']); ?></td>
...
<div class="goodsTitle" style="background:#f6f6f6; border:#E3E3E3 solid 1px; border-bottom:none;">费用总计</div>
	...
	<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
	    <tbody><tr>
		    ...
		    <tr>
		    <td align="right" bgcolor="#ffffff"> 应付款金额: <font class="f1 f14b">￥<?php echo ($money); ?>元</font>
		    </td>
		  </tr>
		</tbody>
	</table>
